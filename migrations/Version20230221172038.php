 ...
 */
final class Version20230221172038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lignedecommande CHANGE totale totale INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lignedecommande CHANGE totale totale INT NOT NULL');
